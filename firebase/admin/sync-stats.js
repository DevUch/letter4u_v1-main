...
async function main() {
  ...
  console.log(
    `Synced publicStats.users = ${userCount} (base ${PUBLIC_USERS_BASELINE} + realtime users ${realtimeUserCount})`
  );
  console.log(
    `Synced publicStats.pages = ${pageCount} (base ${PUBLIC_PAGES_BASELINE} + firestore pages ${firestorePageCount})`
  );
}
